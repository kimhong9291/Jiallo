export const main_script = [
    ...
    },
    {
        ...
        options: [
            ...
            { text: "微笑：「我記住了，$ \text{Love}$ 永遠排在 $ \text{Data}$ 前面。」", score: 20, next: '22', reaction: "建成臉紅到脖子根：「你、你別多想，這只是個隨機密碼！」" },
...

    {
        ...
        options: [
            { text: "笑著說：「我的夢想是，我的未來裡有你。」", score: 25, next: '28', reaction: "建成全身一震，轉頭凝視著你：「你、你說什麼？這個 $ \text{Formula}$ 突然讓我的 $ \text{CPU}$ 過載了！」" },
